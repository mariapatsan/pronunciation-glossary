...
const glossary = document.querySelector(".glossary-container") || document.body;
...
player.addEventListener("error", () => {
  if (currentButton) {
    ...
    status.textContent = `Ошибка загрузки. Синтез речи: ${word}`;
    speakWithBrowser(currentButton);
  }
});
